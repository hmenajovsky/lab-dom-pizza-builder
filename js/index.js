...
function renderPrice() {
  // Iteration 4: change the HTML of `<aside class="panel price">`
    ...
    ingredientsArray.forEach((ingredient) => {
      ...
      document.querySelector('.panel.price ul').appendChild(list).textContent = `$ ${ingredients[ingredient].price} ${ingredients[ingredient].name}`;
...
document.querySelector('.btn.btn-sauce').addEventListener('click', function(e) {
  state.whiteSauce = !state.whiteSauce;
  renderEverything();
});

// Iteration 2: Add click event listener on `<button class="btn btn-crust">`
document.querySelector('.btn.btn-crust').addEventListener('click', function(e) {
